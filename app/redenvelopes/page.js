  ...
  return (
    <main className="min-h-screen bg-[#f4f5f6] flex flex-col w-full relative select-none text-[#333] font-sans pb-12">
      ...
      <div className="flex-1 flex justify-center px-4 mt-8 relative z-10">
        <div className="w-full max-w-[350px] bg-white rounded-[12px] p-6 flex flex-col items-center shadow-lg border border-[#f0f0f0] h-[520px]">
          ...
          <div className="relative w-[320px] h-[320px] my-2 flex items-center justify-center overflow-visible">
            <img
            ...
            <div className="absolute top-[48%] left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center w-full">
              <span className="text-[36px] font-semibold text-[#ffd54f] tracking-wide font-sans drop-shadow-[0_1.5px_1.5px_rgba(0,0,0,0.4)]">
                ₹ {(envelope?.amount ?? 0).toFixed(2)}
              </span>
              
              {/* Success Badge overlay */}
              {isClaimed && (
                <div className="mt-4 bg-[#3e3e3e]/90 rounded-lg px-6 py-1.5 flex items-center justify-center border border-[#525252]/50 shadow-md">
