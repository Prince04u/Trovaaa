    ...
    <main className="account-page account-sub-page">
      ...
      <section className="gift-history-card">
        <div className="gift-history-head">
          {/* Document gold icon */}
          <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="#009688" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        {loadingHistory ? (
          ...
          <div className="gift-history-empty">
            <svg viewBox="0 0 200 140" width="120" height="84" fill="none" style={{ opacity: 0.35, color: "#64748b" }}>
              ...
              <circle cx="140" cy="95" r="16" fill="rgba(0, 150, 136, 0.08)" stroke="#009688" strokeWidth="2"/>
              <path d="M135 95 h10 M140 90 v10" stroke="#009688" strokeWidth="2" strokeLinecap="round"/>
            </svg>
            <p>No data</p>
          </div>
        ) : (
