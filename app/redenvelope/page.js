    ...
    return (
      <main className="min-h-screen bg-[#f4f5f6] flex flex-col w-full relative select-none text-[#333] font-sans pb-12">
        ...
        <div className="flex-1 flex justify-center px-4 mt-8 relative z-10">
          <div className="w-full max-w-[350px] bg-white rounded-[12px] p-6 flex flex-col items-center shadow-lg border border-[#f0f0f0] h-[420px]">
            
            <h2 className="text-[26px] font-bold text-black mt-4 tracking-wide">Surprise</h2>

            {/* Red Envelope Pouch Illustration */}
            <div className="relative w-[180px] h-[215px] my-4 flex items-center justify-center overflow-visible">
              <img
              ...
              <div className="absolute top-[48%] left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center w-full">
                <span className="text-[24px] font-semibold text-[#ffd54f] tracking-wide font-sans drop-shadow-[0_1px_1px_rgba(0,0,0,0.4)]">
