...
export default function PredictorPage() {
  ...
  return (
    <main className="min-h-screen bg-[#06080d] text-slate-100 flex flex-col justify-between items-center p-4 relative font-sans">
      ...
      <style jsx global>{`
        ...
        .bg-green-violet-gradient { background: linear-gradient(135deg, #10b981 50%, #a855f7 50%); }
      `}</style>
                ...
                <div className="bg-slate-950/40 border border-white/5 rounded-2xl p-4 sm:p-5 flex flex-col gap-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="bg-slate-900/40 border border-white/5 rounded-xl p-4 flex flex-col items-center justify-center text-center">
                      ...
                      <div className={`w-11 h-11 rounded-full border border-white/10 flex items-center justify-center text-lg font-bold text-white shadow-md ${
                        ...
                        {history.length === 0 ? (
                          ...
                          history.map((h, i) => (
                            <tr key={i} className="hover:bg-white/[0.01]">
                              ...
                              <td className="px-4 py-2.5">
                                <span className={`inline-block text-center font-bold text-[10px] w-5.5 h-5.5 leading-5.5 rounded-full text-white ${
