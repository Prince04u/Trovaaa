  ...
  return (
    <main className="min-h-screen bg-white pb-24 flex flex-col w-full max-w-none m-0 relative select-none text-[#333333] font-sans">
      ...
      <div className="p-5 text-[13px] leading-relaxed text-[#333] select-text">
        <h2 className="text-[15px] font-bold text-center underline text-black mt-4 mb-3">Chapter 1.Booking/Collection Description</h2>
        <p className="mb-3">Prepayment Booking/Recycling Customer should read and understand the business content carefully before making prepayment bookings (prepayment lock price, payment settlement and shipment) /recovery or repurchase (prepayment lock price, shipping payment) before making prepayment bookings to Terion Shop:</p>
        <ol className="list-decimal pl-5 mb-4 flex flex-col gap-3">
        ...
        <p className="mb-4 font-semibold text-[#009688]">Note: I have carefully read all contents of this app including Privacy Statement, Risk Disclosure Agreement and Risk Agreement and I am agreed to continue with my own risk.</p>
      </div>
