    ...
    <main className="wingo-game">
      <div className="win">
        <div className="mine_top">
            <div className="mine_info" style={{ WebkitTapHighlightColor: "transparent", WebkitTouchCallout: "none", userSelect: "none", display: "flex", flexDirection: "column", padding: "20px 15px 15px 15px", outline: "none" }}>
