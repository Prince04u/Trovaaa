    ...
    <main className="wingo-game">
      <div className="win">
        <div className="mine_top">
            <div className="mine_info" style={{ WebkitTapHighlightColor: "transparent", WebkitTouchCallout: "none", userSelect: "none", display: "flex", flexDirection: "column", padding: "12px 15px 15px 15px", outline: "none" }}>
              ...
              <div className="mine_info_btn" style={{ WebkitTapHighlightColor: "transparent", WebkitTouchCallout: "none", userSelect: "none", outline: "none", background: "transparent", padding: "0", width: "100%", boxSizing: "border-box", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <div className="btn" style={{ display: 'flex', gap: '10px', outline: "none", margin: 0 }}>
                  <button type="button" className="bg-[#2196f3] text-white rounded-[2px]" style={{ WebkitTapHighlightColor: "transparent", fontSize: "14px", fontWeight: "400", padding: "0 16px", display: "flex", alignItems: "center", justifyContent: "center", height: "30px", boxSizing: "border-box", border: "none", outline: "none", cursor: "pointer", boxShadow: "0 1px 3px rgba(0,0,0,0.15)", margin: 0 }} onClick={() => router.push("/recharge")}>Recharge</button>
