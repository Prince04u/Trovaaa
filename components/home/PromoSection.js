...
const PROMOTIONS_DATA = [
  {
    ...
    details: {
      ...
      notes: [
        ...
        "If any agent or member is found to have duplicate accounts, use multiple accounts, engage in fraudulent activities, abuse policies, or make unauthorized withdrawals, Superwin reserves the right to revoke all benefits and profits, terminate participation, and freeze or suspend the account along with all associated balances.",
        "In the event of a dispute, Superwin may require users to provide valid identification and supporting documents as a mandatory condition to receive any benefits or event rewards.",
        "Superwin reserves the full right to interpret, modify, or terminate the event without prior notice. All final decisions rest with Superwin."
      ]
    }
  },
  {
    ...
    details: {
      ...
      notes: [
        ...
        "Advertising support is for new agents only, for 15 days. If agents fail to bring any profit, Superwin reserves the right to modify or cancel the salary model."
      ]
    }
  },
  {
    ...
    details: {
      ...
      notes: [
        ...
        "If any bonus abuse or fraudulent activity is detected, the bonus will be confiscated and withdrawals will not be processed. Superwin reserves the right of final interpretation of this event.",
  ...
  },
  {
    ...
    details: {
      ...
      notes: [
        ...
        "If the agent engages in duplicate registration or registers multiple accounts, Superwin reserves the right to cancel or revoke benefits, profits, or delete the agent's rights.",
        "The offer is specifically designed for members. If any individual is found to withdraw rewards or engage in dishonest behavior, such as abusing Superwin's benefits, Superwin reserves the right to freeze or cancel the account and its balance.",
        "In the case of a dispute between members regarding the event, Superwin officials have the right to request that members provide complete and valid documents to verify whether they are entitled to the privilege, in order to ensure the rights of both parties and prevent identity theft.",
        "Superwin reserves the right to have the final explanation regarding the event, as well as the right to modify and terminate the event without prior notice."
      ]
    }
  }
];
